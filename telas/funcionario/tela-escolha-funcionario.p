...
'2) Editar funcionario'       AT 30 SKIP(1)
'3) Deletar funcionario'      AT 30 SKIP(1)
'0) Sair'                     AT 30 SKIP(2)
'Opcao desejada: '            AT 30
WITH TITLE 'Construtora - Funcionarios' CENTERED WIDTH 100.
...
CASE wopcaoescolhida:
    ...
    WHEN 1 THEN RUN telas/funcionario/tela-cadastro-funcionario.p.
    WHEN 2 THEN RUN telas/funcionario/tela-edicao-funcionario.p.
    WHEN 3 THEN RUN telas/funcionario/tela-deletar-funcionario.p.
END CASE.
